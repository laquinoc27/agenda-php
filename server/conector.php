...
class ConectorBD
{
  /********* Parámetros para conexión al servidor local MySQL ********************************/
  ...
  public $database = 'db_agendaphp_nextu'; //Nombre de base de datos
  /*******************************************************************************************/
  ...
  /*Función para consultar información almacenada en tablas de una base de datos*/
